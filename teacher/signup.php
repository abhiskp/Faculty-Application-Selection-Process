...
if(isset($_POST['submit'])) 
  {
    ...
    $query =$dbh->prepare("SELECT ID  from  tblteacher where Email='$email' ||  MobileNumber='$mobnum'");
    //echo "<script>alert('T222*************************');</script>";
    #$query-> bindParam(':phoneno', $emailid, PDO::PARAM_STR);
    #$query-> bindParam(':password', $phoneno, PDO::PARAM_STR);
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                     <h3 style="color:black;font-weight:bold">Applicant Registration </h3>
                    <hr  color="red"/>
                </div>
